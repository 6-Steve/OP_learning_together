...
train_dir = "E:/classify/cats_vs_dogs-main/cats_vs_dogs/data/train/"                 # 训练集的文件夹路径
logs_train_dir = "E:/classify/cats_vs_dogs-main/cats_vs_dogs/log/"   # 记录训练过程与保存模型的路径
...
with tf.Session() as sess:
    ...
    try:
        ...
        plt.legend()                    # 给图加上图例
        plt.show()                      # 显示图片
        plt.savefig("E:/classify/cats_vs_dogs-main/cats_vog/accs_dogs/luracy_loss.png",dpi=300)
